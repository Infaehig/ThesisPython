...
if __name__ == '__main__':
    ...
    if create:
        netgen_csg.create_patches(aa=aa, patch_num=3, alpha=1.25, beta=2.0, max_resolution=max_resolution, max_refines=max_refines, num=4, create_inclusions=True, prefix=prefix, logger=logger, lshape=False)
