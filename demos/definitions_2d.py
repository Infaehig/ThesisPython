...
ff = dolfin.Constant((0., -10.))
uu = problem.assemble_and_solve(ff, [(dolfin.Constant((-0.1, 0)), 1), (dolfin.Constant((0.1, 0)), 2)], [(dolfin.Constant((0, -100)), 3), (dolfin.Constant((0, 100)), 4)])
